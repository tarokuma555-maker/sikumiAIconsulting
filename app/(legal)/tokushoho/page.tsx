  ...
  { label: "販売URL", value: LEGAL.siteUrl || "—" },
  {
    ...
    value: (
      <>
        ...
        <br />
        定着プラン:総額240,000円(税込・6ヶ月/月額40,000円×6回)
        <br />
        <span className="legal-note">
          いずれのプランも金額は無料相談時に確定してお伝えし、開始後に追加請求することはありません。
          分割払いのご相談も承ります。
        </span>
      </>
    ),
  ...
  { label: "支払時期", value: LEGAL.paymentTiming },
  {
    ...
    value: (
      <>
        ...
        <br />
        伴走プラン・定着プラン:お支払いの確認後、日程を調整のうえセッションを開始します。
      </>
    ),
  },
  {
    ...
    value: (
      <>
        ...
        <br />
        <br />
        <strong>伴走プラン・定着プラン(期間契約のサービス)</strong>
        <br />
        契約期間は、伴走プランが3ヶ月、定着プランが6ヶ月です。
        契約期間中の中途解約、およびお支払い済み料金の返金はお受けできません。
        契約期間の満了後に継続をご希望の場合は、あらためてお申し込みいただきます
        (自動更新は行いません)。
        <br />
        <br />
        <span className="legal-note">
